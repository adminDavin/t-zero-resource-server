package com.t.zero.common.base.idgenerator;
...
/**
 * @author amos 这个类是抄的java.util.UUID, toString()方法中去掉中划线"-"
 */
public final class UUID implements java.io.Serializable, Comparable<UUID> {
     ...
     *
     * <p>
     * The variant field contains a value which identifies the layout of the {@code UUID}. The bit layout described
     * above is valid only for a {@code
     ...
     * UUID}. There are four different basic types of UUIDs: time-based, DCE security, name-based, and randomly
     * generated UUIDs. These types have a version value of 1, 2, 3 and 4, respectively.
     *
     * <p>
