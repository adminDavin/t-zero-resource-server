...
public class FileHandlerHelper {
    ...
    public void directDownload(String userAgent, String range, String resInfoStore, HttpServletResponse response) {
        minIoUtil.download(userAgent, range, resInfoStore, response);
    }
